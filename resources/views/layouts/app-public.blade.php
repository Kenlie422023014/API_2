...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="keywords" content="ecommerce,Interior">
        <meta name="author" content="422023014 - Kenlie Athalla Bintang">

        <title>@yield('title') | 422023014 - Kenlie Athalla Bintang</title>
